<template>
  <v-container class="code-of-conduct">
    <v-card elevation="3">
      <v-card-title>QuestLists Code of Conduct</v-card-title>
      <v-card-text>
        <p>
          QuestLists is an open-sourced, collaborative project which has crowd-sourced data. This means the community
          will be interacting with others a lot. In order to ensure fairness and inclusion, we are enforcing the
          Contributor Covenant. This covenant applies to code and data contributors. Due to the nature of QuestLists,
          this means by using our service, you are implicitly agreeing you will abide by this covenant.
        </p>
        <section>
          ...
          <p>
            ...
            responsible for enforcement at <a href="mailto:skamansam@gmail.com?subject=QuestLists Conduct Violation">
              skamansam@gmail.com</a>.All complaints will be reviewed and investigated promptly and fairly.
          </p>
          <p>
            All community leaders are obligated to respect the privacy and security of the reporter of any incident.
          </p>
          <h2 id="enforcement-guidelines">
          ...
          <p>
            ...
            <a href="https://www.contributor-covenant.org">Contributor Covenant</a>, version 2.0, available at
          ...
          <p>
            ...
            <a href="https://github.com/mozilla/diversity">Mozilla’s code of conduct enforcement ladder</a>.
          </p>
          <p>
