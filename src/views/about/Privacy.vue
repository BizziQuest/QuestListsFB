    ...
    <v-card elevation="3">
      ...
      <v-card-text>
        <p>
          ...
          to information collected by this website, except where stated otherwise. It will notify you of the following:
        </p>
        <ul>
        ...
        <section>
          ...
          <p>
            That being said, we crowdsource all information except user information, so we can ONLY remove your personal
            information and identifier as creator/updater of any crowdsourced information. Of special note is that parts
          ...
          <p>
            ...
            additional disclosures are required. Please take special notice of the California Online Privacy Protection
            Act (CalOPPA), which is frequently amended and now includes a disclosure requirement for “Do Not Track”
            signals.
          </p>
          <h2 id="enforcement">
            If you feel that we are not abiding by this privacy policy, you should contact us immediately via email at
            <a href="mailto:skamansam@gmail.com">skamansam@gmail.com</a>.
          </h2>
        </section>
      </v-card-text>
    </v-card>
